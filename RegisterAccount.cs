        ...
        private void SignUpbtn_Click(object sender, EventArgs e)
        {
            if (CheckData())
            {
                ...
                try
                {
                    ...
                    var nv = new NHANVIEN() { ID = randomcode,  TEN = txbHo.Text+" "+ txbTen.Text, SDT = txbSDT.Text, MAIL = txbGmail.Text,PICBI=Converter.Instance.ImageToByte(pcbxAvatar.Image),IsDeleted=false,isAvailable=true,IDACC= randomcode };
